...
export class AdvertisementCacheService {
  //   //private advertisementCache = new Map<any, PaginatedItem<Advertisement>>();
  ...
  //     advListType: AdvListType,
  //     paginationParams?: PaginationParams
  //   ): PaginatedItem<Advertisement> | undefined {
  ...
  //   }
  //   //Second step
  //   setCache(advertisements: PaginatedItem<Advertisement>) {
  ...
  //       key,
  //       new PaginatedItem(cloneDeep(advertisements))
  //     );
  //     */
  //   }
  ...
  //     } else {
  //       // const newPaginatedResult = new PaginatedItem([advertisement]);
